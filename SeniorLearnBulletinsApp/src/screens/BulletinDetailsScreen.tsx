        ...
        <View style={styles.postContainer}>
          ...
          <View style={styles.metadataContainer}>
            <View style={styles.metadataRow}>
              <Text style={[styles.label, settingsStyle]}>
                Type: {bulletin.type === "official" ? "Official" : "Member"}
              </Text>
            </View>
            <View style={styles.metadataRow}>
              <Text style={[styles.label, settingsStyle]}>
                Created By: {bulletin.createdBy}
              </Text>
            </View>
            <View style={styles.metadataRow}>
              <Text style={[styles.label, settingsStyle]}>
                Created At:{" "}
                {new Date(bulletin.createdAt).toLocaleDateString("en-AU", {
                  year: "numeric",
                  month: "long",
                  day: "numeric",
                  hour: "2-digit",
          ...
          <View style={styles.postField}>
            ...
            <ScrollView style={styles.contentScrollView}>
              <Text style={[styles.postContent, settingsStyle]}>
                {bulletin.content}
              </Text>
            </ScrollView>
          </View>{" "}
